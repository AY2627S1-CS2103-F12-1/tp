...
/**
 * Adds, replaces, or clears a remark on an existing person.
 */
public class RemarkCommand extends Command {

    public static final String COMMAND_WORD = "remark";
    public static final String MESSAGE_USAGE = COMMAND_WORD
            + ": Adds or replaces a person's remark. Use an empty remark to clear it.\n"
    ...
    /**
     * Creates a command to set the remark of the person at {@code index}.
     */
